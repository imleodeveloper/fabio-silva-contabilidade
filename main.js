...
document.addEventListener("DOMContentLoaded", () => {
  ...
  [...clientsForSlider, ...clientsForSlider, ...clientsForSlider].forEach(
    (client) => {
      sliderClients.innerHTML += `
            <div class="client">
  ...
  const servicesArray = [
    ...
    },
    {
      ...
      link: "/servicos/imposto-de-renda.html",
    },
    {
      id: 3,
      ...
      link: "/servicos/carne-leao-de-profissionais-liberais.html",
    },
    {
      id: 4,
      ...
      link: "/servicos/abertura-de-empresa.html",
    },
    {
      id: 5,
      ...
      link: "/servicos/encerramento-de-empresa.html",
    },
    {
      id: 6,
      ...
      link: "/servicos/area-de-departamento-pessoal.html",
    },
    {
      id: 7,
      ...
      link: "/servicos/contabilidade-e-area-fiscal.html",
    },
    {
      id: 8,
      service: "Doméstica",
    ...
    },
    {
      ...
      link: "/servicos/contabilidade-consultiva.html",
    },
  ];
  ...
  const feedbackContainer = document.querySelector(
    ".feedbacks-home section .content .container"
  );
  const feedbackWrapper = document.querySelector(
    ".feedbacks-home section .content .container .feedbacks-wrapper"
  );
  ...
  const FAQuestions = [
    ...
    },
    {
      id: 2,
      title:
        "Preciso trocar minha contabilidade, porém não sei como funciona. Podem me auxiliar?",
